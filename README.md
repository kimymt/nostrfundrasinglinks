...
概要: fiatjaf氏がその時に関心を持っているテーマのOSSに対して資金を提供する取り組み。詳細とファンド情報についてはNostrクライアントでご確認ください。

**Nostr address:**
```
naddr1qq9rzd3cxumrget9xd3kxet9vshhxetvde6hgetjv4kn2ct5v93xcetev468getnvdskgetn9uuh2arm9e3k7mf0qgsz6mrexa5h6ue98ueuawmsyxj88ndpjshnpef936zrqskzvvqxr63765e
```

上記のNostr addressをお使いのNostrクライアントに貼り付けることで、fiatjaf氏の最新の関心テーマと資金提供情報をご覧いただけます。
